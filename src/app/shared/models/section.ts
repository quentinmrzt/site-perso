...
export const SECTIONFORMATIONS: Section[] = [
  {
    titre: "Master Génie Informatique",
    date: "2017 - 2019",
...
export const SECTIONEXPERIENCES: Section[] = [
  {
    titre: "Développeur en alternance",
    date: "Depuis Septembre",
    lieu: "Efluid, Metz",
    resume: "",
    detail: "Développeur Java au sein de l'équipe contrat sur le progiciel Efluid. Réalisation de correction de bug, maintenance de code et qualité, mise en place de tests unitaires, 100% coverage, et ajouts de nouvelles fonctionnalités."
  },
  {
    ...
    resume: "",
    detail: "Gestion de plusieurs rayons du magasin. Exécution de tâches diverses allant de la mise en place des marchandises, la gestion des stocks et l'approvisionnement de ceux-ci."
  },
  {
...
export const SECTIONCOMPETENCES: Section[] = [
	{
    titre: "Langages",
    date: "",
    lieu: "",
    resume: "Java, C, C++, Python, C#",
		detail: ""
	},
	{
	...
	},
  {
    ...
    date: "",
    lieu: "",
		resume: "Eclipse, Visual Studio, Atom",
    detail: ""
	},
  {
